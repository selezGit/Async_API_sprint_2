...
@pytest.mark.asyncio
async def test_genre_all_valid_data(prepare_es_genre, make_get_request, redis_client):
    # Выполнение запроса
...
@pytest.mark.asyncio
async def test_genre_all_not_valid_params(prepare_es_genre, make_get_request, redis_client):
    # Выполнение запроса
...
@pytest.mark.asyncio
async def test_genre_detail_valid_data(prepare_es_genre, make_get_request, redis_client):
...
@pytest.mark.asyncio
async def test_genre_detail_not_valid_data(prepare_es_genre, make_get_request, redis_client):
